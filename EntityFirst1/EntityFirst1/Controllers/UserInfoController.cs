...
namespace EntityFirst1.Controllers  //code displayed on url "/userinfo"
                                    //code first, entity scafolding. manual migration for database. 
                                    //"add-migration InitialCreate" in Package Manager Console at Bottom of editor.
                                    //update-databse to excute the sql commands and create database in MSSQL
{
    public class UserInfoController : Controller
    {
        private readonly UserReport _context;

        public UserInfoController(UserReport context)
        {
            _context = context;
        }
